...
# -------------------------------
# Calculate the total cost of 3 items priced at ₦12,500 each
# with a 7.5% VAT added. Print the total cost.
# No.4 Answer Here

item_3 = 3 * 12,500 * 7.5%100
print(item_3)
...
comparison = (100 >= 99) and (Python == python)
print(comparison)
...
create_variables = has_degree == True or has_experience
